<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" Inherits="J.ZenCode.CodeShow"
    CodeBehind="CodeShow.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var editor = CodeMirror.fromTextArea(document.getElementById("ctl00_ybContent_content"), {
                lineNumbers: true,
                autoCloseTags: true,
            ...
            function change() {
                var val = $("#ctl00_ybContent_mode").val(), mode, spec;
